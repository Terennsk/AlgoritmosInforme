...
public class Ejercicio {
	// recibe una matriz de pesos
	
	public String algortimoFloyd(long[][] nADY) {
		int vertices = nADY.length;
		long matrizAdyacencia[][] = nADY;
		...
		return "La matriz de caminos mas cortos entre los diferentes vertices es \n" + cadena
				+ "\n los diferntes caminos mas cortos entre vertices son: \n" + caminitos;
	}
